        ...
        <div className="panel animate-visible">
          ...
          <div className="panel-body">
            <form onSubmit={handleSubmit}>
                ...
                onMouseOut={e => e.currentTarget.style.borderColor = 'var(--glass-border)'}>
                  ...
                  {imagePreview ? (
                    ...
                    <label style={{ cursor: 'pointer', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
                      ...
                      <h4 style={{ margin: '0', fontWeight: '600', color: 'var(--text-primary)', fontSize: '1.1rem' }}>Upload Vehicle Photo</h4>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '.85rem', marginBottom: '20px' }}>Upload legal registration & compliance documents for vehicle verification & admin approval.</p>
